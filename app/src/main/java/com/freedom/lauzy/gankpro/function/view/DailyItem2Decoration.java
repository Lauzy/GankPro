...
public class DailyItem2Decoration extends RecyclerView.ItemDecoration {
    ...
    private static final String LYTAG = DailyItem2Decoration.class.getSimpleName();
    ...
    public DailyItem2Decoration(Context context, List<ItemBean> itemBeen) {
